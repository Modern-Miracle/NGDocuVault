...
import { DidRegistryABI } from '../../constants';
...
export class DidRegistryService {
  ...
  /**
   * Resolves a DID to get its full document.
  ...
  async didExists(did: string): Promise<boolean> {
    try {
      ...
      return (
        document &&
        document.subject !== '0x0000000000000000000000000000000000000000'
      );
    } catch (error) {
