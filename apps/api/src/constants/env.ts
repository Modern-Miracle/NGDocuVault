...
export const TESTNET_RPC_URL = process.env.TESTNET_RPC_URL as string;
...
export const TESTNET_NETWORK_ID = process.env.TESTNET_NETWORK_ID as string;
...
// testnet
export const TESTNET_CONTRACT_ADDRESS = process.env
  .TESTNET_CONTRACT_ADDRESS as string;
export const TESTNET_DID_AUTH_CONTRACT_ADDRESS = process.env
  .TESTNET_DID_AUTH_CONTRACT_ADDRESS as string;
export const TESTNET_DID_REGISTRY_CONTRACT_ADDRESS = process.env
  .TESTNET_DID_REGISTRY_CONTRACT_ADDRESS as string;
export const TESTNET_DID_VERIFIER_CONTRACT_ADDRESS = process.env
  .TESTNET_DID_VERIFIER_CONTRACT_ADDRESS as string;
export const TESTNET_DID_ISSUER_CONTRACT_ADDRESS = process.env
  .TESTNET_DID_ISSUER_CONTRACT_ADDRESS as string;
export const TESTNET_DOCU_VAULT_CONTRACT_ADDRESS = process.env
  .TESTNET_DOCU_VAULT_CONTRACT_ADDRESS as string;
...
export const TESTNET_PRIVATE_KEY = process.env.TESTNET_PRIVATE_KEY as string;
