// NOTE: This are the accounts that are used in Hardhat Development Environment. These are the public account that should not be used in any crypto transactions in production. We are using here for testing purposes.
const accounts = {
  Deployer: {
