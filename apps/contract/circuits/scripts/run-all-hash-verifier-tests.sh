...
OUT_DIR="${PROJECT_ROOT}/circuits/out/hashverifier"
...
TS_SIMPLE_TEST="${PROJECT_ROOT}/circuits/__test__/hashverifier/HashVerifierSimpleTest.ts"
...
if [ ! -f "$TS_SIMPLE_TEST" ]; then
    ...
    OUT_DIR=$OUT_DIR npx ts-node hashverifier/HashVerifierSimpleTest.ts
    TS_SIMPLE_STATUS=$?
...
TS_DETAILED_TEST="${PROJECT_ROOT}/circuits/__test__/hashverifier/HashVerifierDetailedTest.ts"
...
if [ ! -f "$TS_DETAILED_TEST" ]; then
    ...
    OUT_DIR=$OUT_DIR npx ts-node hashverifier/HashVerifierDetailedTest.ts
    TS_DETAILED_STATUS=$?
...
TS_STANDARD_TEST="${PROJECT_ROOT}/circuits/__test__/hashverifier/HashVerifierTest.ts"
...
if [ ! -f "$TS_STANDARD_TEST" ]; then
    ...
    OUT_DIR=$OUT_DIR npx ts-node hashverifier/HashVerifierTest.ts
    TS_STANDARD_STATUS=$?
...
MOCHA_TEST="${PROJECT_ROOT}/circuits/__test__/hashverifier/HashVerifierMochaTest.ts"
...
if [ ! -f "$MOCHA_TEST" ]; then
    ...
    OUT_DIR=$OUT_DIR npx mocha --require ts-node/register 'hashverifier/HashVerifierMochaTest.ts' --timeout 60000
    MOCHA_STATUS=$?
