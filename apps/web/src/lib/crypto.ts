 ...
 * @typedef {Object} AsymmetricEncryptOutput
 * @property {string} ephemeralPublicKey - The ephemeral public key used in the ECDH key exchange.
 * @property {string} iv - The initialization vector (IV) used during encryption.
 * @property {string} authTag - The authentication tag generated during encryption, used to verify the integrity of the encrypted data.
 * @property {string} encrypted - The encrypted data as a string, typically represented in hex encoding.
 */
