...
export type ResolversTypes = {
  AgeVerification: ResolverTypeWrapper<
    Omit<AgeVerification, "verifier"> & { verifier: ResolversTypes["Verifier"] }
  >;
  Authentication: ResolverTypeWrapper<
    Omit<Authentication, "did"> & { did: ResolversTypes["DID"] }
  >;
  ...
  Credential: ResolverTypeWrapper<
    Omit<Credential, "subject"> & { subject: ResolversTypes["DID"] }
  >;
  ...
  Verification: ResolverTypeWrapper<
    ResolversInterfaceTypes<ResolversTypes>["Verification"]
  >;
...
export type CredentialResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["Credential"],
> = {
...
export type DidResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["DID"],
> = {
  active?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
  controller?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
  credentials?: Resolver<
    Array<ResolversTypes["Credential"]>,
    ParentType,
    ContextType
  >;
...
export type DidHolderResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["DidHolder"],
> = {
  did?: Resolver<ResolversTypes["DID"], ParentType, ContextType>;
...
export type HolderResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["Holder"],
> = {
...
export type IssuerResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["Issuer"],
> = {
...
> = {
  did?: Resolver<
    Maybe<ResolversTypes["DID"]>,
    ParentType,
    ContextType,
    RequireFields<QueryDidArgs, "id">
  >;
  dids?: Resolver<
    Maybe<Array<ResolversTypes["DID"]>>,
    ParentType,
    ContextType,
    Partial<QueryDidsArgs>
  >;
  document?: Resolver<
    Maybe<ResolversTypes["Document"]>,
    ParentType,
  ...
  documents?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<QueryDocumentsArgs>
  >;
  documentsCount?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  holder?: Resolver<
    Maybe<ResolversTypes["Holder"]>,
    ParentType,
    ContextType,
    RequireFields<QueryHolderArgs, "id">
  >;
  holders?: Resolver<
    Maybe<Array<ResolversTypes["Holder"]>>,
    ParentType,
    ContextType,
    Partial<QueryHoldersArgs>
  >;
  holdersCount?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  issuer?: Resolver<
    Maybe<ResolversTypes["Issuer"]>,
    ParentType,
    ContextType,
    RequireFields<QueryIssuerArgs, "id">
  >;
  issuers?: Resolver<
    Maybe<Array<ResolversTypes["Issuer"]>>,
    ParentType,
    ContextType,
    Partial<QueryIssuersArgs>
  >;
  issuersCount?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  ...
  >;
  verifiers?: Resolver<
    Maybe<Array<ResolversTypes["Verifier"]>>,
    ParentType,
    ContextType,
    Partial<QueryVerifiersArgs>
  >;
};

export type RoleResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["Role"],
> = {
  did?: Resolver<ResolversTypes["DID"], ParentType, ContextType>;
...
export type ShareRequestResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["ShareRequest"],
> = {
...
export type TrustedIssuerResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["TrustedIssuer"],
> = {
  credentialType?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  issuer?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
...
export type VerificationResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["Verification"],
> = {
  __resolveType: TypeResolveFn<
    "AgeVerification" | "FhirVerification" | "HashVerification",
    ParentType,
    ContextType
  >;
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type VerifierResolvers<
  ContextType = GraphQLContext,
  ParentType = ResolversParentTypes["Verifier"],
> = {
  address?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
  ...
  verifications?: Resolver<
    Array<ResolversTypes["Verification"]>,
    ParentType,
    ContextType
  >;
